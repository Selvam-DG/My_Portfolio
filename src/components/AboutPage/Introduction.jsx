export default function Introduction() {
    return (
        <section id="introduction" className="bg-white shadow-lg rounded-xl p-8 space-y-4 scroll-mt-24 border border-gray-200">
            ...
            <p className="mb-2">
                💻 Currently, I’m working as a Software Engineer Intern - Digital Twin at fischer group, where I contribute to developing internal tools that support data-driven decision-making. This hands-on role has enhanced my skills in Python, data handling, and web development (including HTML, CSS, JavaScript, and the Django web framework), empowering me to build scalable, user-friendly applications.
            </p>
            <p className="mb-2">
                🔍 I’m especially excited by the intersection of AI, automation, and intelligent systems, and I enjoy applying my engineering mindset to solve technical challenges in innovative ways.
            </p>
            <p>
                🌟 What sets me apart is my hybrid profile: a mechanical engineering Data Analyst background, strong coding skills, and a growing expertise in intelligent technologies — all aimed at building smarter, more autonomous systems.
            </p>
